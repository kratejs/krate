...
// TailwindTheme holds user-customizable theme values for the Tailwind generator.
...
func defaultSizing() map[string]string {
	return map[string]string{
		"0":    "0",
		"px":   "1px",
		"0.5":  "0.125rem",
...
func defaultColors() map[string]map[string]string {
